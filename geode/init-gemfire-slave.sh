...
###############################################
# Filename:    init-gemfire-slave.sh 
# Version:     1.0
# Date:        2019-10-23
# Author:      LiuBaoWen
# Email:       bwliush@cn.ibm.com
# Description: 初始化gemfire slave服务
# Notes:       
###############################################
...
backup_dir=/opt/app/gemfirebak/data/$date
        ...
        echo '备份gemfire-slave数据开始.........'
mkdir -p $backup_dir
mv $source_dir* $backup_dir/
        echo '备份gemfire-slave数据完成.........'
        
        echo '部署gemfire-slave服务开始.........'
${gfsh} <<EOF
...
EOF
	jps;
	echo "部署gemfire-slave结果:>>>>>>>>> $?"
        echo '部署gemfire-slave服务结束.........'
